...
@Component({})
export class SkAutocompleteOptionsComponent<T> extends tsx.Component<SkAutocompleteOptionsComponentProps<T>, SkAutocompleteOptionsComponentEventsWithOn<T>>
        ...
        return (
            <div class="sk-autocomplete-options">
                {this.options.map((option) => (
                    ...
                    >
                        <div class="sk-autocomplete-options__option-title">{option.title}</div>
                        <div class="sk-autocomplete-options__option-description">{option.description}</div>
                    </div>
                ))}
            </div>
        );
