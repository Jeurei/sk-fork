...
export class SkHeaderComponent extends tsx.Component<{}> {
  ...
  @Watch("stateKind")
  protected __onStateKindChanged(
    newStateKind: string | null,
    oldStateKind: string | null
  ) {
    if (
      ["driver_assigned", "car_at_place"].indexOf(newStateKind || "") !== -1
    ) {
  ...
  render() {
    ...
    switch (this.orderState?.state_kind) {
      ...
      default:
        logoPlace = <div class="sk-header__logo">ЗАКАЗ ТАКСИ ОНЛАЙН</div>;
        break;
    }
    ...
    return (
      <div class="sk-header">
        ...
        {skModule.skOrderState ? (
          <div class="sk-header__call">
            <button
              tabindex="9"
              type="button"
              class="sk-button sk-button_dispatcher"
              onClick={() => this.callDispatcher()}
            >
        ...
        <SkDialogComponent
          show={this.showInvalidPhone}
          onClose={() => (this.showInvalidPhone = false)}
        >
          ...
          <template slot="buttons">
            <button
              ...
              onClick={() => (this.showInvalidPhone = false)}
            >
              ОК
            </button>
          </template>
        ...
        <SkDialogComponent
          show={this.showCancelSearch}
          onClose={() => (this.showCancelSearch = false)}
        >
          ...
          <template slot="buttons">
            ...
            <button
              ...
              class="sk-dialog__button"
              tabindex="12"
              onClick={() => (this.showCancelSearch = false)}
            >
              Нет
            </button>
          </template>
        ...
        <SkDialogComponent
          show={this.showCancelOrder}
          onClose={() => (this.showCancelOrder = false)}
        >
          ...
          <template slot="buttons">
            <button
              type="button"
              class="sk-dialog__button fix-class-1"
              autofocus
              tabindex="11"
            ...
            <button
              ...
              class="sk-dialog__button"
              tabindex="12"
              onClick={() => (this.showCancelOrder = false)}
            >
              Нет
            </button>
          </template>
